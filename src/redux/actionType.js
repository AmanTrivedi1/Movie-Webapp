...
export const SEARCHED_VIDEO_REQUEST = "RELATED_VIDEO_REQUEST";
export const SEARCHED_VIDEO_SUCCESS = "RELATED_VIDEO_SUCCESS";
export const SEARCHED_VIDEO_FAIL = "RELATED_VIDEO_FAIL";
